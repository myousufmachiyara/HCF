                ...
                <tr>
                  ...
                  <td>
                      @foreach($transfer->details as $detail)
                          <div>
                              <small>
                                  <span class="text-muted">{{ $detail->product->name ?? '-' }}:</span>
                                  <span class="badge bg-info">{{ $detail->lot_number ?? 'N/A' }}</span>
                                  <span class="text-muted">({{ number_format($detail->quantity, 2) }})</span>
                              </small>
                          </div>
                      @endforeach
                  </td>
